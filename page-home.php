...
<section class="home-hero">
  <div class="white-block">
    <h1>Power Up Your Product with <span class="purple">UX</span></h1>
    <span class="tagline">Build great products that people Love</span>
  </div>
</section>
      ...
      <ul class="h-carousel">
        <li>
          <div class="process-card">
            ...
            <div class="process-card-content">
              ...
              <p>Understanding user’s needs, limitations, and emotions will shape the way your product is developed. 
                <span class="hideOnMobile">It allows you to build only what is necessary and gives you a validated 
                  approach that it will be well accepted.
                </span>
              </p>
              <a class="learnmore" href="http://ux.nearsoft.com/user-research-is-key-to-understand-your-audience/">
                Learn More
              </a>
            </div>
          </div>
        ...
        <li>
          <div class="process-card">
            ...
            <div class="process-card-content">
              ...
              <p>A correct interpretation of all the data will uncover what the motivations and emotions behind the 
              feedback are. 
                <span class="hideOnMobile">This means we need to translate the research conclusions into insights that 
                  will form and inform your product’s next design iteration.
                </span>
              </p>
        ...
        <li>
          <div class="process-card">
            ...
            <div class="process-card-content">
              <h3>UI Solutions</h3>
              <p>A design solution must boost your product user experience as well as your business goals. 
                <span class="hideOnMobile">We prototype and test the solutions with users and stakeholders. We also work 
                  with your development team to make the implementation seamless.
                </span>
              </p>
    ...
    <section class="section-showcase">
      ...
      <div class="two_column">
        <div class="column">
          ...
          <div class="content">
            <h3 class="purple">
              <a class="purple" href="https://ux.nearsoft.com/portfolio/#cogia-home">Cogia Intelligence</a>
            </h3>
  ...
  <section class="home-testimonials">
    ...
    <div class="quote-cards">
      <ul class="card-slider">
        <li>
          <div class="quote-card">The UX team was so helpful for us because a lot of times you need a fresh, 3rd party 
            eyes to really get valuable feedback. It's very easy to get too used to your UX and start making bad 
            decisions based on your own feelings.
            <div class="quote-author">
              <div class="quote-author-pic">
                <img src="https://ux.nearsoft.com/wp/wp-content/themes/ux/img/andrew-pic.jpg" />
              </div>
        ...
        <li>
          <div class="quote-card">It is very easy to get too used to your own UX and UI. You start making bad decisions 
            based on your own feelings. Working with the UX Team was extremely useful to get objective feedback on our 
            product.
            <div class="quote-author">
              <div class="quote-author-pic">
                <img src="https://ux.nearsoft.com/wp/wp-content/themes/ux/img/dustin-pic.jpg" />
              </div>
              <div class="quote-author-content">
    ...
    <section class="section-showcase blog-showcase">
      <div class="section-showcase-header">
        <div class="left-column">
          ...
          <p>A resource for you to learn more about UX, including our own findings, and hints of where the UX world is 
            going.
          </p>
        </div>
...
<script>
(function() {
  var slider = $("ul.h-carousel").bxSlider({
    infiniteLoop: false,
    mode: 'vertical',
    pager: 'true',
