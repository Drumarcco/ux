...
<div class="services-cont">
  <div class="blocks">
     <a href="http://ux.nearsoft.com/user-research-is-key-to-understand-your-audience/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/user-research-uxteam.jpg"></a>
     <div class="block-text-cont">
        <h2><a href="http://ux.nearsoft.com/user-research-is-key-to-understand-your-audience/">User Research</a></h2>
        <p>1-on-1 feedback sessions give us an idea of what your product is telling your users.</p>
     </div>
  </div>
    <div class="blocks">
      <a href="http://ux.nearsoft.com/finding-patterns-through-data-analysis/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/data-interpretation-uxteam.jpg"></a>
     <div class="block-text-cont">
        <h2><a href="http://ux.nearsoft.com/finding-patterns-through-data-analysis/">Data Analysis</a></h2>
        <p>We work with you to analyze user feedback and turn it into actionable insights.</p>
     </div>
  </div>
    <div class="blocks">
       <a href="http://ux.nearsoft.com/ui-design-must-reflect-the-ux-solution/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ux-solutions-uxteam.jpg"></a>
     <div class="block-text-cont">
        <h2><a href="http://ux.nearsoft.com/ui-design-must-reflect-the-ux-solution/">UX Solutions</a></h2>
