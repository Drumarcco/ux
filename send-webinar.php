...
if(
  ...
  $_SERVER['HTTP_REFERER'] == 'http://ux.nearsoft.com/impact-your-business-growth-integrating-analytics-and-ux/' &&
  !(strrpos($_POST['path'], 'url='))) {
    ...
    $subject = 'Registration Email for Webinar';
    $body = $email_message;

    $sent = send_email(array(
        'to' => 'svazquez@nearsoft.com',
        'from' => 'Webinar Registration <avega@nearsoft.com>',
        'subject' => $subject,
        'text_body' => $body
    ), $response, $http_code);
    ...
    if( $sent ) {
        header( 'Location: http://ux.nearsoft.com/webinar-confirm-registration/' );
    } else {
